...
class YoloCameraNode(Node):
    def __init__(self):
        ...
        # Paths for models
        self.detection_model_path = "yolo11n.pt"
        self.segmentation_model_path = "yolo11n-seg.pt"
        # Initialize YOLO models if available
        if ULTRALYTICS_AVAILABLE:
            try:
                # Load general detection and segmentation models
                self.detection_model = YOLO(self.detection_model_path)
                self.segmentation_model = YOLO(self.segmentation_model_path)
